...
export function useUpload(useBrowserAI) {
    ...
    const submitScreening = async () => {
        ...
        try {
            ...
            if (!useBrowserAI) {
                ...
                const response = await axios.post(`${apiUrl}/api/screen`, formData, {
                ...
                const extractRes = await axios.post(`${apiUrl}/api/extract`, formData, {
                    headers: { "Content-Type": "multipart/form-data" },
                });
